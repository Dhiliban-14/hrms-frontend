  ...
  return (
    <div className="bg-[#FEFEFE] min-w-screen min-h-screen overflow-hidden">
      ...
      <div className="flex pt-0 pr-6 pb-8 pl-6 flex-col items-start rounded-[40px] border-t border-t-[#FEFEFE] border-l border-l-[#FEFEFE] bg-[rgba(249,250,251,0.50)] w-[1056px] h-[914px] absolute left-[322px] top-[83px]">
        ...
        <div className="inline-grid pb-6 w-full relative">
          <div className="flex p-6 flex-col items-start gap-6 rounded-2xl border border-[#E5E7EB] bg-[#FFF] w-full absolute left-0 top-0">
          ...
          <div className="flex pb-[106px] flex-col items-start gap-6 w-full absolute left-[693px] top-0">
